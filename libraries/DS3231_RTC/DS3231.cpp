...
// Additional code from Affan
void DS3231::getAlarm1(byte& A1Hour, byte& A1Minute) {
	byte temp_buffer;
	byte A1Second;
	_Wire.beginTransmission(CLOCK_ADDRESS);
	_Wire.write(0x07);
...
void DS3231::getAlarm2(byte& A2Hour, byte& A2Minute) {
	byte temp_buffer;
	_Wire.beginTransmission(CLOCK_ADDRESS);
	_Wire.write(0x0b);
	_Wire.endTransmission();
...
void DS3231::setAlarm1(byte A1Hour, byte A1Minute) {
...
void DS3231::setAlarm2(byte A2Hour, byte A2Minute) {
...
// last additional code from Affan
