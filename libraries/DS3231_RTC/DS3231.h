...
class DS3231 {
	public:
		...
		// Alarm functions
		// Affan's code addition for alarm
		void getAlarm1(byte& A1Hour, byte& A1Minute);
		void getAlarm2(byte& A1Hour, byte& A1Minute);
		void setAlarm1(byte A1Hour, byte A1Minute);
		void setAlarm2(byte A1Hour, byte A1Minute);
		// only until this code
